...
parser.add_argument('--workdir', default='/home/pokyuser',
                    help='The active directory once the container is '
                    'running. In the abscence of the "id" argument, '
                    ' the uid and gid of the workdir will also be '
                    ' be used for the user in the container.')
...
if args.id:
    ...
    # usersetup won't be able to calculate it
    # from the non-existent workdir
